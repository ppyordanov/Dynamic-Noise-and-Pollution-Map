...
var absoluteMaxNO2 = 1.6; //most toxic

var absoluteMaxRouteDistance = 1500; //1.5km
var absoluteMaxRouteDuration = 15 * 60;//duration in seconds, 15 minutes

var noiseMultiplier, coMultiplier, no2Multiplier, routeDistanceMultiplier, routeDurationMultiplier;

var defaultNoiseMultiplier = 0.20; //20% weight
var defaultCoMultiplier = 0.20; //20% weight
var defaultNo2Multiplier = 0.58; //58% weight most toxic
var defaultRouteDistanceMultiplier = 0.01; //1% weight
var defaultRouteDurationMultiplier = 0.01; //1% weight
